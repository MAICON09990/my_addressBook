    ...
    stages {
      ...
      stage('4. Docker image build') {
         steps{
          ...
          sh "sudo docker tag addressbook:latest ${params.aws_account}.dkr.ecr.us-east-2.amazonaws.com/address_book:${params.ecr_tag}"
          sh "sudo docker push ${params.aws_account}.dkr.ecr.us-east-2.amazonaws.com/address_book:${params.ecr_tag}"
         }
       }
